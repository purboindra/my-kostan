    ...
    <Dialog.Root open={isOpen} defaultOpen={isOpen} onOpenChange={onChange}>
      <Dialog.Portal>
        <Dialog.Overlay className="bg-blackColor bg-opacity-30 backdrop-blur-sm inset-0 fixed">
          <Dialog.Content className="bg-white py-[25px] px-12 focus:outline-none fixed drop-shadow-md border-[1px] border-[#C4C4C4] rounded-xl top-[50%] left-[50%] h-full md:h-auto md:max-h-auto w-full md:w-[90vw] md:max-w-[450px] translate-x-[-50%] translate-y-[-50%]">
